# Basic Feedforward Neural Network with TensorFlow

This project implements a basic feedforward neural network using TensorFlow on a synthetic classification dataset.
...
2. Navigate to the project directory: `cd 05_nn_tensorflow`
